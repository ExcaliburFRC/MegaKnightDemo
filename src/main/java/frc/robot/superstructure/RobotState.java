...
public enum RobotState {
    ...
    SCORE_L3_(ArmPosition.TILTED_BRANCH_CORAL_SCORE, ElevatorStates.L3, IntakeState.DEFAULT, GripperStates.CORAL),
    ...
    NET_SCORE_STAGE_1(ArmPosition.NET, ElevatorStates.NET, IntakeState.DEFAULT, GripperStates.RELEASE_ALGAE),
    NET_SCORE_STAGE_2(ArmPosition.NET, ElevatorStates.NET, IntakeState.DEFAULT, GripperStates.RELEASE_ALGAE),
    NET_SCORE_STAGE_3(ArmPosition.NET, ElevatorStates.NET, IntakeState.DEFAULT, GripperStates.RELEASE_ALGAE),
    NET_SCORE_STAGE_4(ArmPosition.NET, ElevatorStates.NET, IntakeState.DEFAULT, GripperStates.RELEASE_ALGAE),
    NET_SCORE_STAGE_5(ArmPosition.NET, ElevatorStates.NET, IntakeState.DEFAULT, GripperStates.RELEASE_ALGAE),


    FLOOR_INTAKE(ArmPosition.DOWNWARDS, ElevatorStates.SAFE_HEIGHT, IntakeState.FLOOR_INTAKE, GripperStates.VACENT),
    FLOOR_INTAKE_WITH_ALGAE(ArmPosition.UPWARDS, ElevatorStates.DEFAULT_WITH_ALGAE, IntakeState.FLOOR_INTAKE, GripperStates.ALGAE),
