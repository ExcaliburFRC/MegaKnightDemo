...
public class IntakeSubsystem extends SubsystemBase implements Logged {
    ...
    public IntakeSubsystem() {
        ...
        armSoftLimit = new SoftLimit(
                () -> 0, // The number is just a placeholder
                () -> 0 // The number is just a placeholder
        );
        ...
        leftSensorTrigger = new Trigger(() -> leftSensor.getValue() < 0); // The number is just a placeholder
        rightSensorTrigger = new Trigger(() -> rightSensor.getValue() < 0); // The number is just a placeholder
    }
