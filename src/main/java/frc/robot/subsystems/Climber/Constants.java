...
public class Constants {
    ...
    public static final int MOTOR1_ID = 1; //Just a placeholder number
    public static final int MOTOR2_ID = 2; //Just a placeholder number
    public static final int ROLLER_MOTOR_ID = 3; //Just a placeholder number

    public static final double ARM_POSITION_CONVERSION_FACTOR = 0; Just a placeholder number
